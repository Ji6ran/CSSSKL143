 ...
 * Author: Rob Nash
 * 
 * 1.) I prefer to assert as it just seems more easy to not get lost with it, and is equivalent
 * 	   of doing boolean expressions pretty much.
 * 
 * 2.) Using breakpoints would be more feasible for larger amounts of code whereas asserting would be
 * 	   much more useful for small pieces of code, such as comparisons of values.
 * 
 * 3.) An advantage would be not having to type more code whereas you would have to if you were to use
 * 	   asserts, and having a GUI gives a good visualization of how everything in your code looks.
 * 
 * 4.) It's better organized and you can see the values that you are actually trying to view.
 */
...
public class AssertDemo {
	 ...
	 * into the function.
	 * 
	 * The keywords this and input refer to the memory address of the object. If there's
	 * no representation for the instance variables, then the address of where these
