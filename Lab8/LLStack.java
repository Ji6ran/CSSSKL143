 ...
 **/
  ...
  public class LLStack {
      ...
      private class Node  {
        ...
        // Parametrized constructor for inner class
         public Node (Object newData, Node nextLink) {
                 this.data = newData;// to do: Data part of Node is an Object
                 this.next = nextLink;// to do:  Link to next node is a type Node
         }
      }
       ...
       public void addToStart(Object itemData) {
          if (this.head == null) {
              head = new Node(itemData, null);
          }
          else {
              Node t = new Node(itemData, head);
              head = t;
          }
          // to do
       ...
       public Object deleteHead( ) {
          ...
          Node returnObj = head;
          this.head = this.head.next; // temp node setting it to head, setting head to null, and returning the temp node
      ...
      public boolean contains(Object item) {
          Node cur = head; // while you're traversing the list, if the value = the item you pass in, return true
          while(cur.next != null) {
              if (cur.data == item) {
                  return true;
              }
